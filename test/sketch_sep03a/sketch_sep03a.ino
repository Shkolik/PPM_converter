...
#define ticksInMicrosecond F_CPU / 8000000               //tick count in 1us with 1/8 prescaller
...
#define PPM_FrGap (3000 * ticksInMicrosecond)            //set the gap between PPM frames microseconds (1ms = 1000µs)
#define PPM_FrLen (20500 * ticksInMicrosecond)           //set the PPM frame length in microseconds (1ms = 1000µs)
...
void setup()
{
  ...
  interrupts ();                                        // start interrupts handling
}
